  ...
  run: async (client, interaction, args) => {
    ...
    const row = new ActionRowBuilder()
      ...
      .setStyle(ButtonStyle.Link)
        .setURL('https://discord.com/api/oauth2/authorize?client_id=1040624236668141641&permissions=0&scope=bot')
          .setDisabled(false),
        new ButtonBuilder()
          .setCustomId('next')
